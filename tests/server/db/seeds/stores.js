  ...
  return knex('stores').del()
    .then(function () {
      return knex('stores').insert([
        ...
        {id: 5, name: 'Subway', suburb: 'Newmarket', city: 'Auckland', admin: false, address: '88 Broadway', phone: '027 345 678', lat: -36.865534, lng: 174.779020, image_url: 'image3.jpg', email: 'PP@test.com', hash: '33333', owner: 'Peewee Herman'},
        {id: 6, name: 'BurgerFuel', suburb: 'Mt Roskill', city: 'Auckland', admin: false, address: '22 Stoddard Rd', phone: '021 667 543', lat: -36.907067, lng: 174.733351, image_url: 'image3.jpg', email: 'JB@test.com', hash: '33333', owner: 'Joe Blogs'}
      ])
    })
}
